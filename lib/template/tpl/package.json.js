...
const getTpl = (cliConf) => {
    ...
    const currDate = getDate_1.getFromat('yyyy-mm-dd hh:mi:ss.ms');
    const isLib = ((cliConf.SOURCE_TYPE === "LIB_BROWSER") || (cliConf.SOURCE_TYPE === "LIB_CJS") || (cliConf.SOURCE_TYPE === "LIB_UMD"));
    const mainAndTyping = !isLib ? '' : `\n	"main": "lib/index.js",
	"typings": "lib/index.d.ts",`;
    const scriptStr = ((cliConf.SOURCE_TYPE === "APP_FEND") && scriptFend) || ((cliConf.SOURCE_TYPE === "APP_SVR" && scriptBend)) || scriptLib;
